...
const getStatusColor = (status: 'AVAILABLE' | 'IN_USE' | 'OFFLINE' | 'FAULTED') => {
    switch (status) {
        case 'AVAILABLE':
            return 'bg-green-500';
        case 'IN_USE':
    ...
    return (
        <div className="relative w-full h-full bg-gray-100 rounded-2xl overflow-hidden">
                                    ...
                                    <div className="bg-white rounded-xl shadow-xl p-3 border">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Badge variant="outline" className="text-xs">
                                                {/* (6) SỬA LỖI: Dùng tên trường DTO thật */}
                                                {station.availableChargers}/{station.totalChargingPoint} available
                                            </Badge>
            ...
            <div className="absolute top-4 left-4 bg-blue-50 border border-blue-200 rounded-lg p-2 text-sm text-blue-800">
                📍 Map Placeholder - Real data loaded
            </div>
        </div>
    );
}